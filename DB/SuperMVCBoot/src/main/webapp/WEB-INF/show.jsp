...
<body>
	...
	<div>
		...
		<form action="getStateToUpdate.do" method="GET">
			<input type="hidden" value="${state.id}" name="updateId"> <input
				type="submit" value="Update State">

		</form>


		<form action="destroyState.do" method="GET">
			<input type="hidden" value="${state.id}" name="destroyId"> <input
				type="submit" value="Destroy State">
		</form>
